...
/*
  ...
  [ТРЕБУЕТ ПОДТВЕРЖДЕНИЯ] Полного «как добраться» — вход на территорию,
  парковка, ближайшая остановка, время в пути — здесь нет, и придумывать
  его нельзя. Как только эти сведения подтвердит владелец, им место на
  /bassein/, а сюда достаточно вынести две-три строки.
