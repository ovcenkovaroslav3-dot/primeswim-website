...
/*
  ...
  Баттерфляй пока остаётся исключением: четыре обычных попытки и ещё одна
  с правильными ключевыми позами всё равно дали чрезмерную волну корпусом,
  а в конце цикла модель потеряла одновременность рук.
  ...
  Поэтому баттерфляй остаётся неподвижным силуэтом со своим ритмом
  покачивания — он показывает темп стиля и ничего не утверждает о технике.
...
*/
const HAS_MOTION = new Set(['freestyle', 'backstroke', 'breaststroke']);
