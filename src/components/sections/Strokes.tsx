          ...
          >
            ...
            */}
            <div className="relative overflow-hidden rounded-[16px] bg-abyss-900">
              {/*
                НАД ЛИНИЕЙ ВОЗДУХ, ПОД НЕЙ ВОДА — И ЭТО ЕДИНСТВЕННОЕ, ЧТО
                ЗАПОЛНЯЕТ ПАНЕЛЬ.

                Раньше здесь лежала одна диагональная заливка от фиолетового к
                лайму. Она давала две беды сразу: лайм на тёмном в 18%
                отдаёт оливковым — цветом, которого в палитре нет, — а по
                смыслу диагональ не говорила ничего. Панель читалась тёмным
                прямоугольником, в котором висит фигура, и пустоты над и под
                ней было больше, чем самой фигуры.

                Теперь заливка горизонтальная и делится ровно там же, где
                проходит линия воды. Сверху воздух: ровный тёмный фон, чуть
                светлее к верхнему краю. Снизу вода: свет входит у самой
                поверхности и гаснет с глубиной — так, как он и ведёт себя в
                чаше.

                Слой лежит ПОВЕРХ ролика, а не под ним: погружённая половина
                тела должна быть притушена водой, иначе пловец выглядит
                наклеенным на воду, а не плывущим в ней. Под волной (z-10),
                чтобы она осталась самой светлой линией панели.
              */}
              <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-x-0 top-0 z-[5] h-1/2 bg-linear-to-t from-transparent to-brand-600/16"
              />
              <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-x-0 top-1/2 bottom-0 z-[5] bg-linear-to-b from-brand-400/20 via-brand-600/12 to-transparent"
              />
              ...
              <div className="relative aspect-900/740">
                {/*
                  ...
                  Волн на самом деле две — разной длины и идущих навстречу
                  друг другу, — потому что одна синусоида читается
                  нарисованной кривой: у неё виден период. Разбор и числа —
                  в globals.css у `.stroke-waterline`. Снос очень медленный:
                  вода должна дышать, а не течь.
                ...
                */}
                <span
                  aria-hidden="true"
                  className="stroke-waterline pointer-events-none absolute inset-x-0 top-1/2 z-10 h-3.5 -translate-y-1/2"
                />
                {/*
