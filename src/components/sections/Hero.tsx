...
/*
  Три факта первого экрана — те, о которых родитель спрашивает первым делом.
  ...
  Фактов три, а не четыре: цена переехала в строку под кнопками — см.
      ...
      */}
      ...
      <div className="hero-depart mx-auto w-full max-w-[75rem] px-5 pt-14 pb-16 sm:px-6 sm:pt-20 md:pt-28 md:pb-24">
        {/*
          ...
          два из трёх («до 12», «45 минут») уже сказаны словами в лиде.
        ...
        */}
        <div className="flex flex-col gap-10 md:grid md:grid-cols-[minmax(0,1fr)_minmax(0,22rem)] md:items-center md:gap-x-12 md:gap-y-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,26rem)] lg:gap-x-16">
          ...
          */}
          ...
          <div className="min-w-0">
            <dl
              className="reveal glass grid max-w-xl grid-cols-3 gap-x-4 gap-y-5 rounded-[20px] p-5 sm:p-6"
