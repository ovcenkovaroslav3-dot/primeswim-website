...
/*
  Видео есть только там, где техника прошла покадровую проверку. Для каждого
  принятого ролика браузеру нужны оба формата: WebM первым и MP4 запасным.
*/
test('у проверенных анимаций гребка есть WebM и MP4', () => {
  for (const id of ['freestyle', 'backstroke', 'breaststroke', 'butterfly']) {
