...
export const metadata: Metadata = {
  ...
  /*
    Подтверждение прав в Яндекс Вебмастере. Метатег, а не файл в public:
    файл легко потерять при чистке, а этот код лежит рядом с остальными
    метаданными и виден при чтении. Секрета в нём нет — он в любом случае
    попадает в исходник страницы. Убирать после подтверждения нельзя:
    Вебмастер периодически перепроверяет права.
  */
  verification: { yandex: '4a1632cf4544cf96' },
};
